...
def create_database():
    con=driver.connect(host='localhost',user='root', passwd='Kpn@y@k1600', charset='utf8')
    if con.is_connected():
...
def create_table():
    con=driver.connect(host='localhost',user='root',passwd='Kpn@y@k1600',charset='utf8',database='employee')
    if con.is_connected():
        print("Successfully Connected")
    cur=con.cursor()
